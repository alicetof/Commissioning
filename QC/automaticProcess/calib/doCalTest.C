...
void doCalTest(int runarg){
  for(int isec=0; isec < 18; isec++){
    h2d[isec] = new TH2F(Form("h2d_%d",isec),";nchannel;#Deltat (ps)", o2::tof::Geo::NCHANNELS/18, 0, o2::tof::Geo::NCHANNELS/18, 12500/4, -50000, 75000);
    h2dTRD[isec] = new TH2F(Form("h2dTRD_%d",isec),";nchannel;#Deltat (ps)", o2::tof::Geo::NCHANNELS/18, 0, o2::tof::Geo::NCHANNELS/18, 12500/4, -50000, 75000);
  }
