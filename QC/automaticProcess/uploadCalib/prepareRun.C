void prepareRun(int run=544392, int jira=4940){
  system(Form("cat ../tobeproc |grep %d >input1",run));
  ...
  system(Form("cp %s %s",Form("../TOF/Calib/ChannelCalib/%d_ts.root",run),Form("TOF/Calib/ChannelCalib/%d_ts.root",run)));
